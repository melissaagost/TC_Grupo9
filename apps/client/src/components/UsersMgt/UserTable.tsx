    ...
    return (
        ...
        <div className=" font-raleway flex flex-col lg:px-10 lg:py-0  py-10 px-0">
          ...
          {toastMessage && (
            ...
            <button    onClick={() => {resetForm(); setIsCreating(true);}} className="font-semibold transition-all duration-300 hover:-translate-y-1 shadow-md px-4 py-2 mt-5 w-53 gap-1 inline-flex items-center bg-blood-100 text-white rounded-3xl hover:bg-blood-300"> <Plus size={'20'}/> Agregar un Usuario</button>
            ...
            <Dialog open={isCreating} onClose={() => setIsCreating(false)}>
                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleCreateUser} className="flex flex-col gap-3">
                            <input className="border-eggshell-creamy border-1 shadow-sm bg-pink-100 text-gray-500  p-2 rounded-md w-full mt-2 mb-2" placeholder="Nombre" value={nombre} onChange={(e) => setNombre(e.target.value)} />
                            <input className="border-eggshell-creamy border-1 shadow-sm bg-pink-100 text-gray-500  p-2 rounded-md w-full mt-2 mb-2" placeholder="Email" value={correo} onChange={(e) => setCorreo(e.target.value)} />
                            <input className="border-eggshell-creamy border-1 shadow-sm bg-pink-100 text-gray-500  p-2 rounded-md w-full mt-2 mb-2" placeholder="Contraseña" type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                              ...
                              >
                                ...
                                <div className="flex justify-end gap-2 mt-4">
                                    ...
                                    <button type="submit" className="bg-blood-100 hover:bg-blood-300 text-white py-1 px-4 rounded-md">Crear Usuario</button>
